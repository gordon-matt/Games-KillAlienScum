...
public class Healthbar : MonoBehaviour
{
    ...
    [Tooltip("Health variable: (default range: 0-100)")]
    ...
    [Tooltip("Minimum possible heath: (default is 0)")]
    public float minimumHealth = 0;

    // Maximum possible health:
    [Tooltip("Maximum possible heath: (default is 100)")]
    public float maximumHealth = 100;

    // If the character has this health or less, consider them having low health:
    [Tooltip("Low health is less than or equal to this:")]
    public int lowHealth = 33;
    ...
    [Tooltip("High health is greater than or equal to this:")]
    public int highHealth = 66;
